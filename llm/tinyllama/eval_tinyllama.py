"""
Evaluate a finetuned TinyLlama LoRA adapter on a JSONL test set.

Usage:
python models/llm/tinyllama/eval_tinyllama.py \
  --test-jsonl models/llm/tinyllama/splits/test.jsonl \
  --adapter-path /app/Output/tinyllama_finetuned_v2 \
...
# Ensure project root is on sys.path for relative import
...
def parse_args():
    ...
    p.add_argument("--adapter-path", required=True, help="Path to finetuned adapter.")
